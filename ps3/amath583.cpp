...
#include "Matrix.hpp"
#include "Vector.hpp"
#include <functional> // Not present originally, added by vs code on my PC. 
#include <random>
#include <cassert>
#include <cmath>
...
/*
Direct Access without any hoist. 
*/
...
/*
Multiplication with a 2 by 2 hoisting. 
*/
...
/**
Tiling of 32 blocks with, 2 by 2 hoisting on variables. 
*/
...
/**
Computing AA^T with 2 by 2 hoisting and block tiling. 
*/
...
void mult_trans_5(const Matrix& A, const Matrix& B, Matrix& C) {
  ...
  {
    for (size_t i = 0; i < C.num_rows(); i += 2) {
      for (size_t j = i; j < C.num_cols(); j += 2) {
        double t00 = 0;
        double t01 = 0;
        double t10 = 0;
        double t11 = 0;
