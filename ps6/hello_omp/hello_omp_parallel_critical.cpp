...
int main() {
  ...
  #pragma omp parallel
  {
    // This part will display artifacts of race conditions. 
    ...
    // This part is going to be sequantial looking, no matter how many runs.
    // each time, one of the threads spawned from the previous parallel blocks is going to work on this section of the code only. 
    #pragma omp critical
    {
      std::cout << "  ----------------------------------------------------------------" << std::endl;
