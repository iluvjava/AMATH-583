...
set nox2tics
set noy2tics
set title "Graph 4 (OpenMP_4/Run.001/FLOPS.064/OpenMP.0004)"
...
set output "OpenMP_4/Run.001/FLOPS.064/OpenMP.0004/graph4.pdf"
plot "OpenMP_4/Run.001/FLOPS.064/OpenMP.0004/max" using 1:10 with linespoints pt 7 ps 0.4
#EOF
